...
import 'package:mirochapk/model/client.dart';
import 'package:mirochapk/model/client_model.dart';
    ...
    return SingleChildScrollView(
      ...
      child: _clientList != null
          ? DataTable(
              ...
              rows: _clientList
                  .map((client) => DataRow(cells: <DataCell>[
                        DataCell(
